...
class ComponentVersionTests(unittest.TestCase):
    def test_active_components_are_independent_and_ios_is_deferred(self) -> None:
        self.assertEqual(versions.component_version("android"), "0.4.0")
        self.assertEqual(versions.component_version("obs"), "0.4.0")
    ...
    def test_release_tags_select_their_component(self) -> None:
        ...
        versions.verify_release("android", "0.4.0")
        versions.verify_release("obs", "0.4.0")
