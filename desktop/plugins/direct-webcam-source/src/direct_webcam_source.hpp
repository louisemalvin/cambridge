...
class DirectWebcamSource {
public:
    DirectWebcamSource(SourceConfig config, obs_source_t *source);
    ~DirectWebcamSource();

    DirectWebcamSource(const DirectWebcamSource &) = delete;
    DirectWebcamSource &operator=(const DirectWebcamSource &) = delete;
